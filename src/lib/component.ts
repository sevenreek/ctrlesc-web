...
export type UnaryDigitalStateComponent = components['schemas']['UnaryDigitalStateComponent'];
...
export function inferComponentType(component: { type: UIComponentType }) {
	switch (component.type) {
		case 'unaryDigitalState':
			return component as UnaryDigitalStateComponent;
		case 'digitalState':
